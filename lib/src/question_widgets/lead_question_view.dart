...
class LeadQuestionView extends StatefulWidget {
  ...
  LeadQuestionView({this.reversed = false, this.question});

  @override
  _LeadQuestionViewState createState() {
    return _LeadQuestionViewState(question);
  }
}
...
class _LeadQuestionViewState extends State<LeadQuestionView>
  ...
  _LeadQuestionViewState(Question question) {
